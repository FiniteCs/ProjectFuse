...
namespace Fuse.CodeAnalysis.Binding
{
    internal sealed class Conversion
    {
        ...
        public static readonly Conversion Explicit = new(exists: true, isIdentity: false, isImplicit: true);
        public static readonly Conversion Implicit = new(exists: true, isIdentity: false, isImplicit: false);
